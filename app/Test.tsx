...
import { valentineQuotes } from './phrases'; // Don't forget to import!
    ...
    <div className={`relative flex items-center justify-center h-screen ${bgColors[page]} transition-colors duration-1000 ease-in-out p-4 overflow-hidden`}>
      ...
      >
        ...
        <AnimatePresence mode="wait">
          <motion.div
            key={page + (page === storyPages.length - 1 ? quoteIndex : 0)} // Keys by page AND quote
          ...
          >
            ...
            {/* The Image/Heart logic from Step 2 goes here */}
        ...
        <AnimatePresence mode="wait">
          ...
          >
            ...
            {/* If it's NOT the last page, show the image */}
            {page < storyPages.length - 1 ? (
              ...
              /* If it IS the last page, show a big decorative Heart instead of an image */
              <motion.div 
                initial={{ scale: 0 }}
                animate={{ scale: 1 }}
